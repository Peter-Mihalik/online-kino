...
<div class="dmcaKontaktNavrhNahlasitBlock">
<?php
    if (isset($_GET['error1'])) {
        echo "<div class='error'><h3>VYPLNTE VŠETKY POLIA</h3></div>";
    }
    else if (isset($_GET['error2'])) {
        echo "<div class='error'><h3>ZADAJTE PLATNÝ E-MAIL</h3></div>";
    }
    else if (isset($_GET['succes'])) {
        echo "<div class='succes'><h3>FILM BOL ÚSPEŠNE NAHLÁSENÝ</h3></div>";
    }
?>
<?php
include 'header.php'
...
<main>
        ...
        <div class="content">
            <h2>NAVRHNÚŤ FILM</h2>
            <form class="report-form" action="inc/navrh.inc.php" method="post">
                <input type="text" name='name' placeholder='Názov filmu'>
                <input type="text" name='csfd' placeholder='Odkaz na ČSFD'>
