        ...
        <html lang='en'>
           <head>
               ...
               <meta name='description' content='Sleduj Policajt v Beverly Hills III (3) online CZ/SK dabing/titulky'>
               ...
               <meta property='og:title' content='Policajt v Beverly Hills III (3)' />
               <meta property='og:image' content='5e3aff61a08224.78082870.jpgg'>
               <meta property='og:type' content='video.movie'>
               <meta property='og:url' content='kino-online.online/beverly-hills-cop-3.php'>
            <meta property='og:description' content='Sleduj filmy online bez obmedzení. Naša stránka Online kino vám ponúka veľký výber online filmov k zliahnutiu kedykoľvek a kdekoľvek.'>
               ...
               <title>Policajt v Beverly Hills III (3) online CZ/SK</title>
...
<header>
    ...
    <div class='content'>
        <h1>Policajt v Beverly Hills III (3)</h1>
        <div class='movie-box'>
            <div class='buttons'>
                ...
                <iframe style="margin:10px auto; display: block;" class="playerOne" src="//mixdrop.co/e/847wqxjmx9" frameborder="0" allowfullscreen></iframe>
            ...
            <h2>Sleduj Policajt v Beverly Hills III (3) online</h2>
            <p class='inf'>
                Policista Axel Foley je na stopě zlodějům aut. Odmítne pomoc zásahové jednotky, protože má dojem, že to není nutné. Jsou to jen mechanici, ne pistolníci. Bohužel jeho předpoklad není zcela správný. Zloději jsou sice mechanici, ale ten, kdo si je najmul, nemá vůbec žádný problém se zabíjením a všechny je nechá zabít. Do přestřelky se bohužel připlete i Axelův nadřízený Douglas Todd a je zabit. Setkává se s agentem FBI Fullbrightem, který žádá Axela, aby po vrazích nepátral. Jsou jim na stopě již dlouho a potřebuje, aby byli zločinci ještě chvíli na svobodě. Axel se přesto rozhodne vrahy vypátrat a jeho kroky vedou opět do Beverly Hills, konkrétně do zábavního parku Wonder World. V Beverly Hills se opět setkává s Billem Roswoodem, který mezitím povýšil. Bill hodlá Axelovi v pátrání pomoci. Příběh je poněkud zamotaný, pod rouškou bezpečnostní agentury a maskou bezúhonného muže, který pomáhá potřebným, Axel poznává vraha svého šéfa – Ellise DeWalda. DeWald a jeho kumpáni jsou padělatelé pe
            </p>
