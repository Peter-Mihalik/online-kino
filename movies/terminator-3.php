        ...
        <html lang='en'>
           <head>
               ...
               <meta name='description' content='Sleduj Terminator 3: Vzbura strojov online CZ/SK dabing/titulky'>
               ...
               <meta property='og:title' content='Terminator 3: Vzbura strojov' />
               <meta property='og:image' content='5e0547d350d607.12614845.webpg'>
               <meta property='og:type' content='video.movie'>
               <meta property='og:url' content='kino-online.online/terminator-3.php'>
            <meta property='og:description' content='Sleduj filmy online bez obmedzení. Naša stránka Online kino vám ponúka veľký výber online filmov k zliahnutiu kedykoľvek a kdekoľvek.'>
               ...
               <title>Terminator 3: Vzbura strojov online CZ/SK</title>
...
<header>
    ...
    <div class='content'>
        <h1>Terminator 3: Vzbura strojov</h1>
        <div class='movie-box'>
            <div class='buttons'>
                ...
                <iframe class="playerOne" src="//mixdrop.co/e/97wtctd6v" frameborder="0" allowfullscreen></iframe>
            ...
            <h2>Sleduj Terminator 3: Vzbura strojov online</h2>
            <p class='inf'>
                Od chvíle, kdy John Connor s matkou a terminátorem zabránili zkáze lidstva, uplynulo deset let. John se snaží žít tak, aby ho stroje nedokázaly najít. Vymazal o sobě všechny údaje a zničil vše, co by ho mohlo spojovat s minulostí. Jedné noci se ale objeví nejdokonalejší typ terminátora s označením T-X, který se vydá hledat cíle určené k likvidaci. John je zraněn při autonehodě, a tak se vloupe na veterinární kliniku pro léky. Přistihne ho tam Kate, která se vrátila kvůli jedné ze svých zákaznic. Ukáže se, že se oba znají ze školy, ale dřív než si cokoli stačí vysvětlit, vtrhne na stanici T-X a zabije zákaznici v domnění, že jde o Kate. Zjistí, že v budově je i její hlavní cíl John Connor, ale dřív než je stačí oba zabít, zachrání je starší typ terminátora T-101. Ten pak Johnovi řekne, že byl vyslán, aby ho chránil, a že soudný den byl jejich zásahem před deseti lety pouze oddálen a nyní zbývají do vypuknutí jaderné války pouhé tři hodiny.(CSFD)
            </p>
