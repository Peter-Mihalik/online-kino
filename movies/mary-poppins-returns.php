        ...
        <html lang='en'>
           <head>
               ...
               <meta name='description' content='Sleduj Mary Poppins se vrací / Návrat Mary Poppins online CZ/SK dabing/titulky'>
               ...
               <meta property='og:title' content='Mary Poppins se vrací / Návrat Mary Poppins' />
               <meta property='og:image' content='5e1b62b0629680.42990247.webpg'>
               <meta property='og:type' content='video.movie'>
               <meta property='og:url' content='kino-online.online/mary-poppins-returns.php'>
            <meta property='og:description' content='Sleduj filmy online bez obmedzení. Naša stránka Online kino vám ponúka veľký výber online filmov k zliahnutiu kedykoľvek a kdekoľvek.'>
               ...
               <title>Mary Poppins se vrací / Návrat Mary Poppins online CZ/SK</title>
...
<header>
    ...
    <div class='content'>
        <h1>Mary Poppins se vrací / Návrat Mary Poppins</h1>
        <div class='movie-box'>
            <div class='buttons'>
                ...
                <iframe class="playerOne" src="//mixdrop.co/e/vqmrm7lqdv" frameborder="0" allowfullscreen></iframe>
            ...
            <h2>Sleduj Mary Poppins se vrací / Návrat Mary Poppins online</h2>
            <p class='inf'>
                Film se odehrává kolem roku 1930, v období ekonomické krize v Londýně (v období, ve kterém se odehrávají i původní knihy) a předlohou mu bylo dalších sedm knih od P. L. Traversové. Ve filmu jsou děti známé z původního filmu, Michal (Ben Whishaw) a Jana (Emily Mortimer), už dospělé. V Třešňové ulici žije Michal se svými třemi dětmi a vychovatelkou Ellen (Julie Walters). Poté, co Michal prodělá osobní ztrátu, objeví se v rodině Banksových opět tajemná chůva Mary Poppins (Emily Blunt). Za pomoci veselého lampáře Jacka (Lin-Manuel Miranda) a svých jedinečných kouzelných schopností pomůže rodině znovu nalézt ztracenou radost a štěstí. Mary Poppins rovněž seznámí děti s celou řadou barvitých a svérázných postav, včetně své výstřední sestřenice Topsy (Meryl Streep).(CSFD)
            </p>
