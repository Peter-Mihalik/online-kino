        ...
        <html lang='en'>
           <head>
               ...
               <meta name='description' content='Sleduj Klik - život na dálkové ovládání online CZ/SK dabing/titulky'>
               ...
               <meta property='og:title' content='Klik - život na dálkové ovládání' />
               <meta property='og:image' content='5e09d7da902cc3.22936254.webpg'>
               <meta property='og:type' content='video.movie'>
               <meta property='og:url' content='kino-online.online/klik.php'>
            <meta property='og:description' content='Sleduj filmy online bez obmedzení. Naša stránka Online kino vám ponúka veľký výber online filmov k zliahnutiu kedykoľvek a kdekoľvek.'>
               ...
               <title>Klik - život na dálkové ovládání online CZ/SK</title>
...
<header>
    ...
    <div class='content'>
        <h1>Klik - život na dálkové ovládání</h1>
        <div class='movie-box'>
            <div class='buttons'>
                ...
                <iframe style="margin:10px auto; display: block;" class="playerOne"  src="//mixdrop.co/e/89b6hvyr3jzd" frameborder="0" allowfullscreen></iframe>
            ...
            <h2>Sleduj Klik - život na dálkové ovládání online</h2>
            <p class='inf'>
                Michael Newman (Adam Sandler) je věčně ustaraný workholik. Nemá téměř žádný čas na svou ženu (Kate Beckinsale) a děti, zvlášť když musí neustále usilovat o přízeň nevděčného šéfa (David Hasselhoff) a bojovat o zasloužené povýšení. Až potrhlý prodavač Morty (Christopher Walken) mu nabídne klíč ke splnění všech jeho přání: magické dálkové ovládání, díky kterému se může vyhnout všem životním přehmatům, jež pro něj měly stále nepříjemnější důsledky. Michael své nové schopnosti před okolím škodolibě tají, zrychleně přeskakuje nemilé události své rodiny i svých přátel a vůbec si neuvědomuje, že dálkové ovládání postupně přebírá kontrolu nad jeho životem.
Klik - život na dálkové ovládání – to je zábavná a svižná komedie o jednom dobrodružství, které se poněkud vymklo kontrole.(oficiální text distributora)
            </p>
