        ...
        <html lang='en'>
           <head>
               ...
               <meta name='description' content='Sleduj Temný rytíř (2008) online CZ/SK dabing/titulky'>
               ...
               <meta property='og:title' content='Temný rytíř (2008)' />
               <meta property='og:image' content='5e0b63558e1e91.51960783.webpg'>
               <meta property='og:type' content='video.movie'>
               <meta property='og:url' content='kino-online.online/temny-rytier.php'>
            <meta property='og:description' content='Sleduj filmy online bez obmedzení. Naša stránka Online kino vám ponúka veľký výber online filmov k zliahnutiu kedykoľvek a kdekoľvek.'>
               ...
               <title>Temný rytíř (2008) online CZ/SK</title>
    ...
    <div class='content'>
        ...
        <div class='movie-box'>
            <div class='buttons'>
                ...
                <iframe style="margin:10px auto; display: block;" class="playerOne"  src="//mixdrop.co/e/7xiegye" frameborder="0" allowfullscreen></iframe>
                <iframe class="playerTwo" src="//mixdrop.co/e/7xiegye" frameborder="0" allowfullscreen></iframe>
            ...
            <h2>Sleduj Temný rytíř (2008) online</h2>
            <p class='inf'>
                Christian Bale se pod režijní taktovkou Christophera Nolana vrací v roli Bruce Waynea, který v kostýmu netopýřího muže Batmana pokračuje v boji se zločinem ve městě Gotham. A jeho nejnebezpečnějším protivníkem je král zločinců Joker (Heath Ledger).
Akční dobrodružná fantasy v režii Christophera Nolana navazuje na film Batman začíná a Christian Bale si v ní zopakoval roli Batmana/Bruce Waynea v nekončícím boji se zločinem. Wayne v kostýmu netopýřího muže jde spolu s poručíkem Jamesem Gordonem (Gary Oldman) z Gothamské policie po králi zločinců Jokerovi známého podle symbolu - hrací karty s žolíkem - kterou zanechává na místech činu. Vtipálek s prořízlou tváří (Heath Ledger) má tentokrát v plánu Batmanovi dokázat, že slova Gotham a mír nikdy nebudou stát v jedné větě vedle sebe. Na uvolněné místo po bývalém králi místní mafie usedá Sal Maroni (Eric Roberts) a přebírá vládu nad většinou gangů v Gothamu. Na scéně se rovněž objevuje nový státní návladní Harvey Dent (Aaron Eckhart), který b
            </p>
