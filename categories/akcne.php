...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
     <meta name="description" content="Sleduj najlepšie akčne filmy online zadarmo, kedykoľvek a kdekoľvek.">
    <title>Akčne filmy online - Online kino</title>
...
<header>
    ...
    <main>
        ...
        <div class="content">
            <h2>SLEDUJ AKČNÉ FILMY ONLINE</h2>
        ...
        <?php
            ...
            while($msg = mysqli_fetch_assoc($result)) {
                echo "<a href='../movies/".$msg['akcFileName']."'><div class='categoriesMovie'>
                <img src='../movies/imgs/".$msg['akcImg']."'></img>
                <h3>".$msg['akcMovieName']."<h3>
                </div></a>";
            }
