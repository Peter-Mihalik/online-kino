...
<head>
    ...
    <meta name="description" content="Najlepšie rozprávky online zadarmo, kedykoľvek a kdekoľvek.">
    <title>Rozpravky online - Online kino</title>
    ...
    <main>
        ...
        <?php
            ...
            while($msg = mysqli_fetch_assoc($result)) {
                echo "<a href='../movies/".$msg['rozFileName']."'><div class='categoriesMovie'>
                <img src='../movies/imgs/".$msg['rozImg']."'></img>
                <h3>".$msg['rozMovieName']."<h3>
                </div></a>";
            }
