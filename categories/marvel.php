...
<head>
    ...
    <meta name="description" content="Najlepšie marvel filmy online zadarmo, kedykoľvek a kdekoľvek.">
    <title>Marvel filmy online - Online kino</title>
...
<header>
    ...
    <main>
        ...
        <div class="content">
            <h2>SLEDUJ MARVEL FILMY ONLINE</h2>
        ...
        <?php
            ...
            while($msg = mysqli_fetch_assoc($result)) {
                echo "<a href='../movies/".$msg['marFileName']."'><div class='categoriesMovie'>
                <img src='../movies/imgs/".$msg['marImg']."'></img>
                <h3>".$msg['marMovieName']."<h3>
                </div></a>";
            }
