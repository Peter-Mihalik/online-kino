...
<head>
    ...
    <meta name="description" content="Najlepšie horory online zadarmo, kedykoľvek a kdekoľvek.">
    <title>Horory online - Online kino</title>
...
<header>
    ...
    <main>
        ...
        <div class="content">
            <h2>SLEDUJ HORORY FILMY ONLINE</h2>
        ...
        <?php
            ...
            while($msg = mysqli_fetch_assoc($result)) {
                echo "<a href='../movies/".$msg['horFileName']."'><div class='categoriesMovie'>
                <img src='../movies/imgs/".$msg['horImg']."'></img>
                <h3>".$msg['horMovieName']."<h3>
                </div></a>";
            }
