...
<head>
    ...
    <meta name="description" content="Sleduj najlepšie dramatické filmy online zadarmo, kedykoľvek a kdekoľvek.">
    <title>Dramatické filmy online - Online kino</title>
...
<header>
    ...
    <main>
        ...
        <div class="content">
            <h2>SLEDUJ DRAMATICKÉ FILMY ONLINE</h2>
        ...
        <?php
            ...
            while($msg = mysqli_fetch_assoc($result)) {
                echo "<a href='../movies/".$msg['draFileName']."'><div class='categoriesMovie'>
                <img src='../movies/imgs/".$msg['draImg']."'></img>
                <h3>".$msg['draMovieName']."<h3>
                </div></a>";
            }
