...
<head>
    ...
    <meta name="description" content="Najlepšie komédie online zadarmo, kedykoľvek a kdekoľvek.">
    <title>Komédie online - Online kino</title>
    ...
    <main>
        ...
        <?php
            ...
            while($msg = mysqli_fetch_assoc($result)) {
                echo "<a href='../movies/".$msg['komFileName']."'><div class='categoriesMovie'>
                <img src='../movies/imgs/".$msg['komImg']."'></img>
                <h3>".$msg['komMovieName']."<h3>
                </div></a>";
            }
