...
<head>
    ...
    <meta name="description" content="Sleduj najlepšie detiktívne filmy online zadarmo, kedykoľvek a kdekoľvek.">
    <title>Sleduj detektívne filmy online - Online kino</title>
...
<header>
    ...
    <main>
        ...
        <div class="content">
            <h2>SLEDUJ DETEKTÍVNE FILMY ONLINE</h2>
        ...
        <?php
            ...
            while($msg = mysqli_fetch_assoc($result)) {
                echo "<a href='../movies/".$msg['detFileName']."'><div class='categoriesMovie'>
                <img src='../movies/imgs/".$msg['detImg']."'></img>
                <h3>".$msg['detMovieName']."<h3>
                </div></a>";
            }
