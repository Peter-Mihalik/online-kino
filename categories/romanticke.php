...
<head>
    ...
    <meta name="description" content="Najlepšie romantické filmy online zadarmo, kedykoľvek a kdekoľvek.">
    <title>Romanticke filmy online - Online kino</title>
...
<header>
    ...
    <main>
        ...
        <div class="content">
            <h2>SLEDUJ ROMANTICKÉ FILMY ONLINE</h2>
        ...
        <?php
            ...
            while($msg = mysqli_fetch_assoc($result)) {
                echo "<a href='../movies/".$msg['romFileName']."'><div class='categoriesMovie'>
                <img src='../movies/imgs/".$msg['romImg']."'></img>
                <h3>".$msg['romMovieName']."<h3>
                </div></a>";
            }
