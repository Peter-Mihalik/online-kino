...
<head>
    ...
    <title>Online sci-fi filmy - Online kino</title>
...
<header>
    ...
    <main>
        ...
        <div class="content">
            <h2>SLEDUJ VIANOČNE FILMY ONLINE</h2>
        ...
        <?php
            ...
            while($msg = mysqli_fetch_assoc($result)) {
                echo "<a href='../movies/".$msg['viaFileName']."'><div class='categoriesMovie'>
                <img src='../movies/imgs/".$msg['viaImg']."'></img>
                <h3>".$msg['viaMovieName']."<h3>
                </div></a>";
            }
