...
while($row = mysqli_fetch_assoc($result)) {;
        ...
        if (strpos($mPlayerTwo, 'width="560" height="315"') !== false) {
            $mPlayerTwo = str_replace('width="560" height="315"', 'style="margin:10px auto;" class="playerTwo"',$mPlayerTwo);
        }
        else {
            $mPlayerTwo = $mPlayerTwo;
        }
        ...
        <html lang='en'>
           <head>
               ...
               <meta property='og:image' content='".$mImg."g'>
